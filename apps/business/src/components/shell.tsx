    ...
    <div className="flex h-svh min-h-0 flex-col">
      ...
      <header className="flex h-14 shrink-0 items-center justify-between gap-4 border-b bg-[#FAFAFA] px-6">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <span className="shrink-0 rounded-md bg-[#FBE6D3] px-2 py-1 text-[11px] font-semibold tracking-[0.14em] text-[#8A3E0B] uppercase">
            Business
          </span>
        </div>
      ...
      <PopoverTrigger
        render={
          ...
          >
            <span
              aria-hidden
              className="flex size-[18px] items-center justify-center rounded-full bg-[#FBE6D3] text-[11px] leading-none text-[#8A3E0B]"
            >
              💼
            </span>
